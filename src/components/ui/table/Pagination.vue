        ...
        <nav>
          <ul class="pagination">
            <li class={{ disabled: this.currentPage === 1 }}>
              <a href="#" on-click={e => this.firstPage(e)}>
                <span aria-hidden="true">&laquo;&laquo;</span>
              </a>
            </li>
            <li class={{ disabled: this.currentPage === 1 }}>
              <a href="#" on-click={e => this.previous(e)}>
                <span aria-hidden="true">&laquo;</span>
              </a>
            </li>
            {this.paginationItems}
            <li class={{ disabled: this.currentPage === this.lastPage }}>
              <a href="#" on-click={e => this.next(e)}>
                <span aria-hidden="true">&raquo;</span>
              </a>
            </li>
            <li class={{ disabled: this.currentPage === this.lastPage }}>
              <a href="#" on-click={e => this.goTolastPage(e, this.lastPage)}>
