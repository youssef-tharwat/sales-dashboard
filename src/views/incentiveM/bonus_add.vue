<template>
  <div id="incentive-bonus-add">
    <breadcrumb
      title="Dashboard"
      subtitle="Bonus Incentive"
      sub-sub-title="Add Bonus Incentive"
    ></breadcrumb>
              ...
              <form>
                ...
                <div v-if="step === 0" class="row form-group">
                  ...
                  <div class="col-6 mb-4">
                    ...
                    >
                      {{ incentiveBonusErrors.startDate }}
                    </span>
                  </div>
                  <div class="col-6 mb-4">
                  ...
                  >
                    <div>
                      ...
                      <multiselect
                        v-model="incentiveBonus.tiersCount"
                        v-validate="'required'"
                        :options="[1, 2, 3, 4, 5]"
                        :searchable="false"
                    ...
                    <div class="col-lg-12 d-flex flex-column">
                      ...
                      <div class="d-flex">
                        <div class="d-flex flex-column w-100">
                          ...
                          <div v-if="fileUpload" class="mt-3">
                            Selected file:
                              ...
                              >
                                ...
                                <div class="mb-3">
                                  <input
                                    ...
                                    v-validate="'required|integer'"
                                    class="form-control"
                                    :name="'Target Tier ' + tierCounter(index2)"
                                    type="text"
                                  />
                                  <div>
                                    <span class="invalid-field mt-2">
...
import { INCENTIVE_BONUS_UTILITY_REQUEST } from "../../store/modules/incentive/action";
import { INCENTIVE_BONUS_ADD } from "../../store/modules/incentive/action";
...
export default {
  ...
  methods: {
    ...
    async getDealerOutlets() {
      ...
      this.dealerOutlets = res.content;
    ...
    checkDates() {
      if (this.incentiveBonus.startDate && this.incentiveBonus.endDate) {
        const startDate = moment(this.incentiveBonus.startDate).format(
          "YYYY-MM-DD"
        );
        const endDate = moment(this.incentiveBonus.endDate).format(
          "YYYY-MM-DD"
        );
    ...
    handleSubmit() {
      this.$validator.validateAll().then(result => {
        if (result && Object.keys(this.incentiveBonusErrors).length === 0) {
          ...
          this.$store
            .dispatch(INCENTIVE_BONUS_ADD, this.incentiveBonus)
            .then(res => {
              this.submitted = true;
              if (res.resultCode === 0) {
                // this.stepIncrement();
    ...
    doExport() {
      ...
      const fileName = this.isSingleAccu
        ? "inc bonus single accu"
        : this.isSingleNoneAccu
        ? "inc bonus single non-accu"
        : this.isMultipleAccu
        ? "inc bonus multiple accu"
        : this.isMultipleNoneAccu
        ? "inc bonus multiple non-accu"
        : "inc bonus example";
