<template>
  <div id="normal-incentive-entitlement">
    <div class="row">
      <div class="col-lg-12">
        <VueBootstrap4Table
          :classes="classes"
          :rows="normalIncentiveList"
          :columns="columns"
          :config="config"
          :total-rows="total"
          @on-change-query="onChangeQuery"
          @refresh-data="getNormalIncentiveList"
        >
...
export default {
  name: "NormalIncentiveEntitlement",
  components: {
  ...
  data() {
    return {
      ...
      config: {
        ...
        server_mode: false,
        card_title: "Normal Entitlements",
        card_mode: false,
  ...
  methods: {
    ...
    doExport() {
      ...
      const fileName = "normalIncentiveEntitlement";
