<template>
  <div id="bonus-incentive-entitlement">
    <div class="row">
      <div class="col-lg-12">
        <VueBootstrap4Table
          :classes="classes"
          :rows="bonusIncentiveList"
          :columns="columns"
          :config="config"
          :total-rows="total"
          @on-change-query="onChangeQuery"
          @refresh-data="getBonusIncentiveList"
        >
...
export default {
  name: "BonusIncentiveEntitlement",
  components: {
  ...
  methods: {
    ...
    doExport() {
      ...
      const fileName = "bonusIncentiveEntitlement";
